        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/videos">
                  <a className="text-gray-400 hover:text-primary transition-colors">Videos</a>
                </Link>
              </li>
              <li>
                <Link href="/events">
                  <a className="text-gray-400 hover:text-primary transition-colors">Events</a>
                </Link>
              </li>
              <li>
                <Link href="/music">
                  <a className="text-gray-400 hover:text-primary transition-colors">Music</a>
                </Link>
              </li>
              <li>
                <Link href="/gallery">
                  <a className="text-gray-400 hover:text-primary transition-colors">Gallery</a>
                </Link>
              </li>
              <li>
                <Link href="/about">
